...
export default async function Jobs({ searchParams }: {
    ...
    const { data: favorites } = user
        ? check(await c.from('favorites').select('job_id').eq('user_id', user.id))
        : { data: [] };
    ...
    function pageLink(page: number) {
        return '/jobs?' + new URLSearchParams({ ...raw, page: String(page) });
    }
