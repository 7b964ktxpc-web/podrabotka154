...
test('ставка без валюты', () => assert.deepEqual(parseSalary('Ставка 2800'), { salary_min: 2800, salary_max: 2800, salary_type: null }));
test('ставка без валюты за смену', () => assert.deepEqual(parseSalary('Ставка 3300 смена'), { salary_min: 3300, salary_max: 3300, salary_type: 'shift' }));
test('телеграм 2800 за 8 часов', () => assert.deepEqual(parseSalary('2800/8h'), { salary_min: 2800, salary_max: 2800, salary_type: 'shift' }));
test('телеграм ставка 400/2', () => assert.deepEqual(parseSalary('Ставка 400/2'), { salary_min: 400, salary_max: 400, salary_type: 'hour' }));
test('телеграм ставка 400\\2', () => assert.deepEqual(parseSalary('Ставка 400\\2'), { salary_min: 400, salary_max: 400, salary_type: null }));
test('не ловим вес как зарплату', () => assert.equal(parseSalary('Родниковая 2/3, 16 коробок 214кг').salary_min, null));
