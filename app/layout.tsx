...
export const metadata: Metadata = {
  ...
  description: 'Разовые смены и временная работа. Найдите объявление, откройте адрес в 2ГИС или Яндекс Картах и свяжитесь с работодателем.',
  ...
  return (
    <html lang="ru">
      <body>
        <header>
          <div className="wrap">
            <Link href="/" className="brand">подработка<span>154</span></Link>
        ...
        <footer>
          <div className="wrap">
            <div className="row">
              <b>Подработка 154</b>
              <span>Поиск для соискателей бесплатный</span>
