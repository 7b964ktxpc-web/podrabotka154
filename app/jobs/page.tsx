...
import { JobsMapLoader } from '@/components/jobs-map-loader';
...
export default async function Jobs({ searchParams }: {
    ...
    const jobs = (rows ?? []).map((r: { job: Job }) => r.job).filter(Boolean);
